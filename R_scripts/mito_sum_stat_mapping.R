...
all_files_flagstat<- list.files(path = "~/sharedhome/mitoGenome/samtools_sum_mito",pattern = "*\\.txt",full.names = T)
#get all the basenames of the filess
all_files_names<- list.files(path = "~/sharedhome/mitoGenome/samtools_sum_mito",pattern = "*\\.txt",full.names = F)
...
write_csv(read_summary,"~/sharedhome/mito_reads_mapped_all_samples130120.csv")

#### Reads coverage for each sample #####
#list all the files with csv
all_files_coverage<- list.files(path = "~/sharedhome/mitoGenome/samtools_sum_mito",pattern = "*\\.csv",full.names = T)
#get all the basenames of the filess
all_files_names_cov<- list.files(path = "~/sharedhome/mitoGenome/samtools_sum_mito",pattern = "*\\.csv",full.names = F)
...
write_csv(coverage_summary,"~/sharedhome/mito_coverage_summary_130120.csv")